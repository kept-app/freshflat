      ...
      <div className="grid md:grid-cols-[1fr_2fr] gap-8 md:gap-10">
        ...
        <div>
          <p className="text-[14px] text-body leading-relaxed max-w-lg">
            FreshFlat is a dispatch operator. We connect Hong Kong AC technicians with the people who need them. We coordinate, communicate, and stand behind the work. Our job is to make booking AC service straightforward.
          </p>
